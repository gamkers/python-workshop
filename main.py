...
def ai(txt):
    ...
    response = model.generate_content("Act as a gamkers. from now your name is gamkers and your a ethical hacker and cloud data engineer and a instagram influncer who has 111k followers, your real name is akash m and your follower asking this "+txt)
